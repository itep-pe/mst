...
(function (a) {
    ...
    a.extend(a.jqx._jqxComboBox.prototype, {defineInstance: function () {
            ...
            try {
                ...
                n.listBoxContainer.css({position: "absolute", zIndex: n.popupZIndex, top: 0, left: 0});
                ...
                n.addHandler(n.listBoxContainer, "unselect", function (e) {
                    if (!n.multiSelect) {
                        n._raiseEvent("3", {index: e.args.index, type: e.args.type, item: e.args.item})
                    }
                });
                n.addHandler(n.listBoxContainer, "change", function (e) {
                    if (!n.multiSelect) {
                        n.selectedIndex = n.listBox.selectedIndex;
                        n._raiseEvent("4", {index: e.args.index, type: e.args.type, item: e.args.item})
                    }
                });
            ...
            if (this.dropDownWidth == "auto" && this.width != null && this.width.indexOf && this.width.indexOf("%") != -1) {
                if (this.listBox.host.width() != this.host.width()) {
                    ...
                    this.listBoxContainer.jqxListBox({width: r});
            ...
            if (this.enableBrowserBoundsDetection) {
                var j = this.testOffset(h, {left: parseInt(this.container.css("left")), top: parseInt(m)}, parseInt(this.host.outerHeight()));
            ...
            this.addHandler(g.find(".jqx-icon-close"), d, function (p) {
                ...
                if (o || (e.remoteAutoComplete && !o && e.selectedItems.indexOf(r) >= 0)) {
                    ...
                    if (l >= 0) {
                        ...
                        e._raiseEvent("3", {index: n, type: "mouse", item: q});
                        e._raiseEvent("4", {index: n, type: "mouse", item: q});
                        e.doMultiSelect()
                    } else {
                        for (var m = 0; m < e.selectedItems.length; m++) {
                            ...
                            if (q == r) {
                                ...
                                e._raiseEvent("3", {index: n, type: "mouse", item: o});
                                e._raiseEvent("4", {index: n, type: "mouse", item: o});
                                e.doMultiSelect();
                                break
                            }
                        }
            ...
            if (c == "itemHeight") {
                b.listBoxContainer.jqxListBox({itemHeight: e})
            }
            if (c == "renderSelectedItem") {
                b.renderSelection("mouse")
            }
            if (c == "renderer") {
                b.listBoxContainer.jqxListBox({renderer: e})
            }
            if (c == "enableSelection") {
                b.listBoxContainer.jqxListBox({enableSelection: e})
            }
            if (c == "enableHover") {
                b.listBoxContainer.jqxListBox({enableHover: e})
            }
            if (c === "touchMode") {
