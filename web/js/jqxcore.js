...
(function (a) {
    ...
    a.jqx.set = function (f, e) {
        ...
        if (e.length == 1 && typeof (e[0]) == "object") {
            if (f.isInitialized && Object.keys && Object.keys(e[0]).length > 1) {
                ...
                var b = {};
                var c = {};
                a.each(e[0], function (g, h) {
                    var j = f;
                    while (!j.hasOwnProperty(g) && j.base != null) {
                        j = j.base
                    }
                    if (j.hasOwnProperty(g)) {
                        ...
                        if (j.hasOwnProperty(g.toLowerCase())) {
                            if (f[g.toLowerCase()] != h) {
                                b[g.toLowerCase()] = f[g.toLowerCase()];
                                c[g.toLowerCase()] = h;
                                d++
                            }
                        }
            ...
            a.each(e[0], function (g, h) {
                ...
                if (j.hasOwnProperty(g)) {
                    a.jqx.setvalueraiseevent(j, g, h)
                } else {
                    if (j.hasOwnProperty(g.toLowerCase())) {
                        a.jqx.setvalueraiseevent(j, g.toLowerCase(), h)
                    } else {
                        if (a.jqx.propertySetterValidation) {
                            throw"jqxCore: invalid property '" + g + "'"
                        }
                    }
                }
            });
            if (f.batchUpdate != null) {
                f.batchUpdate = null;
                if (f.propertiesChangedHandler && c.length > 1) {
    ...
    a.extend(a.jqx.utilities, {scrollBarSize: 15, touchScrollBarSize: 10, scrollBarButtonsVisibility: "visible", createId: function () {
            var b = function () {
            ...
            if (k) {
                if (g === -1) {
                    this.resizeHandlers.push({id: d[0].id, widget: d, callback: m, data: d.data()})
                }
            }
...
(function (b) {
    ...
    b.fn.extend({ischildof: function (f) {
