...
(function (a) {
    ...
    a.extend(a.jqx._jqxButton.prototype, {defineInstance: function () {
            var b = {cursor: "arrow", roundedCorners: "all", disabled: false, height: null, width: null, overrideTheme: false, enableHover: true, enableDefault: true, enablePressed: true, rtl: false, _ariaDisabled: false, _scrollAreaButton: false, template: "default", aria: {"aria-disabled": {name: "disabled", type: "boolean"}}};
            ...
            b.propertyChangeMap.width = function (h, j, i, k) {
                h._setSize();
                h.refresh()
            };
            b.propertyChangeMap.height = function (h, j, i, k) {
                h._setSize();
                h.refresh()
            };
            ...
            delete b.get;
            delete b.call;
            delete b.propertyChangeMap.roundedCorners;
            delete b.propertyChangeMap.width;
            delete b.propertyChangeMap.height;
            delete b.propertyChangeMap.disabled;
            delete b.propertyChangeMap.rtl;
            delete b.propertyChangeMap.theme;
