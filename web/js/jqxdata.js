...
(function (i) {
    i.jqx.observableArray = function (e, J) {
        ...
        I.toJSON = function (X, O) {
            ...
            var T = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, W = {"\b": "\\b", "\t": "\\t", "\n": "\\n", "\f": "\\f", "\r": "\\r", '"': '\\"', "\\": "\\\\"};
            function M(Z) {
        ...
        I.defineIndexProperty = function (O) {
            if (!(O in I)) {
                var M = function (V, S, U, R) {
                    ...
                    var W = function (ab) {
                        ...
                        if (Q !== T) {
                            ...
                            if (typeof H === "function") {
                                ...
                                H({object: I, type: "update", path: Z, index: Y, name: S, newValue: T, oldValue: aa})
                            }
                        }
                        Q = T;
                        return T
                    ...
                    if (V[S] && S != "length") {
                        if (Object.defineProperty) {
                            Object.defineProperty(V, S, {get: P, set: W})
                        } else {
                ...
                Object.defineProperty(I, O, {configurable: true, enumerable: true, get: function () {
                        return K[O]
                    }, set: function (Q) {
                        var P = K[O];
                        if (I.toJSON(null, P) != I.toJSON(null, Q)) {
                            K[O] = Q;
                            if (typeof H === "function") {
                                H({object: I, type: "update", path: O.toString(), index: O, name: "index", newValue: Q, oldValue: P})
                            }
                            N(Q, O, Q)
                        }
                    }});
        ...
        I.push = function () {
            ...
            for (var N = 0, O = arguments.length; N < O; N++) {
                ...
                if (typeof H === "function") {
                    H({object: I, type: "add", name: "length", index: M, newValue: K.length, oldValue: M})
                }
            }
            return K.length
        };
        I.pop = function () {
            if (~K.length) {
                var M = K.length - 1, N = K.pop();
                delete I[M];
                if (typeof H === "function") {
                    H({object: I, type: "delete", name: "length", index: M, newValue: K.length, oldValue: M})
                }
                return N
            }
        };
        I.unshift = function () {
            ...
            if (typeof H === "function") {
                H({object: I, type: "add", index: M, name: "length", newValue: K.length, oldValue: M})
            }
            return K.length
        };
        I.shift = function () {
            ...
            if (~K.length) {
                ...
                if (typeof H === "function") {
                    H({object: I, type: "delete", index: M, name: "length", newValue: K.length, oldValue: M})
                }
                return N
            }
        };
        ...
        I.splice = function (Q, R, M) {
            ...
            while (R--) {
                ...
                delete I[K.length];
                if (typeof H === "function") {
                    H({object: I, type: "delete", index: Q, name: "length", newValue: -1, oldValue: Q})
                }
            }
            for (var N = 2, S = arguments.length; N < S; N++) {
                ...
                defineIndexProperty(K.length - 1);
                if (typeof H === "function") {
                    H({object: I, type: "add", index: Q, name: "length", newValue: K.length - 1, oldValue: Q})
                }
                Q++
            }
        ...
        Object.defineProperty(I, "length", {configurable: false, enumerable: true, get: function () {
                return K.length
            }, set: function (M) {
                var N = Number(M);
                if (N % 1 === 0 && N >= 0) {
        ...
        I.remove = function (N) {
            ...
            if (I.hasOwnProperty(N)) {
                ...
                K[N] = undefined;
                if (typeof H === "function") {
                    H({object: I, type: "delete", index: N, name: "index", newValue: undefined, oldValue: M})
                }
                return true
            }
            return false
        ...
        Object.getOwnPropertyNames(Array.prototype).forEach(function (M) {
            if (!(M in I)) {
                ...
                Object.defineProperty(I, M, {configurable: false, enumerable: true, writeable: false, value: N})
            }
        });
        I.set = function (N, P) {
    ...
    i.jqx.longInt = function () {
        ...
        var e = H.longObj;
        e.math = new Object();
        e.math.Long = new Object();
        e.math.Long = function (I, J) {
            this.lowBits = I | 0;
            this.highBits = J | 0
        };
        e.math.Long.IntCache = {};
        e.math.Long.fromInt = function (I) {
            if (-128 <= I && I < 128) {
                var K = e.math.Long.IntCache[I];
                if (K) {
                    return K
                }
            }
            var J = new e.math.Long(I | 0, I < 0 ? -1 : 0);
            if (-128 <= I && I < 128) {
                e.math.Long.IntCache[I] = J
            }
            return J
        };
        e.math.Long.fromNumber = function (I) {
            if (isNaN(I) || !isFinite(I)) {
                return e.math.Long.ZERO
            } else {
                if (I <= -e.math.Long.TWO_PWR_63_DBL_) {
                    return e.math.Long.MIN_VALUE
                } else {
                    if (I + 1 >= e.math.Long.TWO_PWR_63_DBL_) {
                        return e.math.Long.MAX_VALUE
                    } else {
                        if (I < 0) {
                            return e.math.Long.fromNumber(-I).negate()
                        } else {
                            return new e.math.Long((I % e.math.Long.TWO_PWR_32_DBL_) | 0, (I / e.math.Long.TWO_PWR_32_DBL_) | 0)
                        }
                    }
                }
            }
        };
        e.math.Long.fromBits = function (I, J) {
            return new e.math.Long(I, J)
        };
        e.math.Long.fromString = function (K, N) {
            if (K.length === 0) {
            ...
            if (K.charAt(0) === "-") {
                return e.math.Long.fromString(K.substring(1), L).negate()
            } else {
                if (K.indexOf("-") >= 0) {
                    throw new Error('number format error: interior "-" character: ' + K)
                }
            }
            var O = e.math.Long.fromNumber(Math.pow(L, 8));
            var Q = e.math.Long.ZERO;
            for (var J = 0; J < K.length; J += 8) {
                var P = Math.min(8, K.length - J);
                var M = parseInt(K.substring(J, J + P), L);
                if (P < 8) {
                    var I = e.math.Long.fromNumber(Math.pow(L, P));
                    Q = Q.multiply(I).add(e.math.Long.fromNumber(M))
                } else {
                    Q = Q.multiply(O);
                    Q = Q.add(e.math.Long.fromNumber(M))
                }
            }
            return Q
        };
        ...
        e.math.Long.prototype.toNumber = function () {
            return this.highBits * e.math.Long.TWO_PWR_32_DBL_ + this.getLowBitsUnsigned()
        };
        e.math.Long.prototype.toString = function (O) {
            var M = O || 10;
            if (M < 2 || 36 < M) {
            ...
            if (this.isNegative()) {
                if (this.equals(e.math.Long.MIN_VALUE)) {
                    var K = e.math.Long.fromNumber(M);
                    var I = this.div(K);
            ...
            var Q = e.math.Long.fromNumber(Math.pow(M, 6));
            P = this;
            R = "";
            while (true) {
                var N = P.div(Q);
        ...
        e.math.Long.prototype.getLowBitsUnsigned = function () {
            return(this.lowBits >= 0) ? this.lowBits : e.math.Long.TWO_PWR_32_DBL_ + this.lowBits
        };
        ...
        e.math.Long.prototype.equals = function (I) {
            return(this.highBits === I.highBits) && (this.lowBits === I.lowBits)
        };
        e.math.Long.prototype.notEquals = function (I) {
            return(this.highBits !== I.highBits) || (this.lowBits !== I.lowBits)
        };
        e.math.Long.prototype.lessThan = function (I) {
            return this.compare(I) < 0
        };
        e.math.Long.prototype.lessThanOrEqual = function (I) {
            return this.compare(I) <= 0
        };
        e.math.Long.prototype.greaterThan = function (I) {
            return this.compare(I) > 0
        };
        e.math.Long.prototype.greaterThanOrEqual = function (I) {
            return this.compare(I) >= 0
        };
        e.math.Long.prototype.compare = function (J) {
            if (this.equals(J)) {
                return 0
            }
        ...
        e.math.Long.prototype.add = function (P) {
            ...
            U += N + S;
            U &= 65535;
            return e.math.Long.fromBits((I << 16) | R, (U << 16) | O)
        };
        e.math.Long.prototype.subtract = function (I) {
            return this.add(I.negate())
        };
        e.math.Long.prototype.multiply = function (P) {
            if (this.isZero()) {
                return e.math.Long.ZERO
            } else {
                if (P.isZero()) {
            ...
            if (this.equals(e.math.Long.MIN_VALUE)) {
                return P.isOdd() ? e.math.Long.MIN_VALUE : e.math.Long.ZERO
            } else {
                if (P.equals(e.math.Long.MIN_VALUE)) {
            ...
            if (this.lessThan(e.math.Long.TWO_PWR_24_) && P.lessThan(e.math.Long.TWO_PWR_24_)) {
                return e.math.Long.fromNumber(this.toNumber() * P.toNumber())
            }
            var N = this.highBits >>> 16;
            var J = this.highBits & 65535;
            var Q = this.lowBits >>> 16;
        ...
        e.math.Long.prototype.div = function (K) {
            if (K.isZero()) {
            ...
            var N, P;
            if (this.equals(e.math.Long.MIN_VALUE)) {
                if (K.equals(e.math.Long.ONE) || K.equals(e.math.Long.NEG_ONE)) {
                    return e.math.Long.MIN_VALUE
                } else {
                    if (K.equals(e.math.Long.MIN_VALUE)) {
                        return e.math.Long.ONE
                    } else {
                        var I = this.shiftRight(1);
                        N = I.div(K).shiftLeft(1);
                        if (N.equals(e.math.Long.ZERO)) {
                            return K.isNegative() ? e.math.Long.ONE : e.math.Long.NEG_ONE
                        } else {
            ...
            while (P.greaterThanOrEqual(K)) {
                ...
                var J = e.math.Long.fromNumber(N);
                var M = J.multiply(K);
                while (M.isNegative() || M.greaterThan(P)) {
                    N -= O;
                    J = e.math.Long.fromNumber(N);
                    M = J.multiply(K)
                }
                if (J.isZero()) {
                    J = e.math.Long.ONE
        ...
        e.math.Long.prototype.modulo = function (I) {
            return this.subtract(this.div(I).multiply(I))
        };
        e.math.Long.prototype.not = function () {
            return e.math.Long.fromBits(~this.lowBits, ~this.highBits)
        };
        e.math.Long.prototype.and = function (I) {
            return e.math.Long.fromBits(this.lowBits & I.lowBits, this.highBits & I.highBits)
        };
        e.math.Long.prototype.or = function (I) {
            return e.math.Long.fromBits(this.lowBits | I.lowBits, this.highBits | I.highBits)
        };
        e.math.Long.prototype.xor = function (I) {
            return e.math.Long.fromBits(this.lowBits ^ I.lowBits, this.highBits ^ I.highBits)
        };
        e.math.Long.prototype.shiftLeft = function (K) {
            K &= 63;
            if (K === 0) {
                return this
            } else {
                ...
                if (K < 32) {
                    var J = this.highBits;
                    return e.math.Long.fromBits(I << K, (J << K) | (I >>> (32 - K)))
                } else {
                    return e.math.Long.fromBits(0, I << (K - 32))
                }
            }
        };
        e.math.Long.prototype.shiftRight = function (K) {
            K &= 63;
            if (K === 0) {
                return this
            } else {
                ...
                if (K < 32) {
                    var I = this.lowBits;
                    return e.math.Long.fromBits((I >>> K) | (J << (32 - K)), J >> K)
                } else {
                    return e.math.Long.fromBits(J >> (K - 32), J >= 0 ? 0 : -1)
                }
            }
        };
        e.math.Long.prototype.shiftRightUnsigned = function (K) {
            K &= 63;
            if (K === 0) {
                return this
            } else {
                ...
                if (K < 32) {
                    ...
                    if (K === 32) {
                        return e.math.Long.fromBits(J, 0)
                    } else {
                        return e.math.Long.fromBits(J >>> (K - 32), 0)
                    }
                }
            }
        }
